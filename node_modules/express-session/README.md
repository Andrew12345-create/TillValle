...
Specifies the `boolean` value for the [`Partitioned` `Set-Cookie`](SCRAMBLED_Longtoken(32+)_a5cd24ce6cc6ce0e)
...
**Note** There is a [draft spec](https://tools.ietf.org/html/SCRAMBLED_Longtoken(32+)_df66a9570eb120d5)
...
[aerospike-session-store-image]: https://badgen.net/github/stars/aerospike/SCRAMBLED_Longtoken(32+)_1af064163f861b35?label=%E2%98%85

[![★][SCRAMBLED_Longtoken(32+)_75aad95470f65eda] better-sqlite3-session-store][SCRAMBLED_Longtoken(32+)_1de6dba68c4790ac] A session store based on [better-sqlite3](https://github.com/JoshuaWise/better-sqlite3).

[SCRAMBLED_Longtoken(32+)_1de6dba68c4790ac]: https://www.npmjs.com/package/better-sqlite3-session-store
[SCRAMBLED_Longtoken(32+)_75aad95470f65eda]: https://badgen.net/github/stars/timdaub/better-sqlite3-session-store?label=%E2%98%85
...
[![★][SCRAMBLED_Longtoken(32+)_486eb52fcb46bf0e] express-session-cache-manager][SCRAMBLED_Longtoken(32+)_925484239060a6f8]
...
[SCRAMBLED_Longtoken(32+)_925484239060a6f8]: https://www.npmjs.com/package/express-session-cache-manager
[SCRAMBLED_Longtoken(32+)_486eb52fcb46bf0e]: https://badgen.net/github/stars/theogravity/express-session-cache-manager?label=%E2%98%85
...
[rfc-6265bis-03-4.1.2.7]: https://tools.ietf.org/html/SCRAMBLED_Longtoken(32+)_476c7a3406632ef8#section-4.1.2.7
[SCRAMBLED_Longtoken(32+)_a5cd24ce6cc6ce0e]: https://tools.ietf.org/html/SCRAMBLED_Longtoken(32+)_63b3bec5d9a82221/
