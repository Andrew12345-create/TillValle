...
| **Build**                                                                                                                               | **Dependency**                                                                                                         |
|SCRAMBLED_Longtoken(32+)_d330b116b732cebd|SCRAMBLED_Longtoken(32+)_1a962c196d6240fe|
| [![Build Status](https://secure.travis-ci.org/auth0/node-jsonwebtoken.svg?branch=master)](http://travis-ci.org/auth0/node-jsonwebtoken) | [![Dependency Status](https://david-dm.org/auth0/node-jsonwebtoken.svg)](https://david-dm.org/auth0/node-jsonwebtoken) |


An implementation of [JSON Web Tokens](https://tools.ietf.org/html/rfc7519).

This was developed against `SCRAMBLED_Longtoken(32+)_664fd56b529bd984`. It makes use of [node-jws](https://github.com/brianloveswords/node-jws)
...
encoded private key for RSA and ECDSA. In case of a private key with passphrase an object `{ key, passphrase }` can be used (based on [crypto documentation](https://nodejs.org/api/crypto.html#SCRAMBLED_Longtoken(32+)_c23177533543300e)), in this case be sure you pass the `algorithm` option.
...
|---------------------|SCRAMBLED_Longtoken(32+)_33a025c8570d19a8|
...
We are not comfortable including this as part of the library, however, you can take a look at [this example](https://gist.github.com/ziluvatar/SCRAMBLED_Longtoken(32+)_3be0792542f9dc6d) to show how this could be accomplished.
