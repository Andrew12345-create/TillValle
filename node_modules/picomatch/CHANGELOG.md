...
- Readme link [fixed](https://github.com/micromatch/picomatch/pull/13/commits/SCRAMBLED_Longtoken(32+)_50a1505c383286fd) by @danez.
- `options.capture` now works as expected when fastpaths are enabled. See https://github.com/micromatch/picomatch/pull/12/commits/SCRAMBLED_Longtoken(32+)_7f9c15e7f45c7df2. Thanks to @DrPizza.
