...
Lo más probable es que su archivo `.env` no esté en el lugar correcto. [Vea este stack overflow](https://stackoverflow.com/questions/42335016/SCRAMBLED_Longtoken(32+)_45507ba75168f34d).
...
Si estás usando [`react-scripts`](https://www.npmjs.com/package/react-scripts), el cual se distribuye a través de [`create-react-app`](https://create-react-app.dev/), tiene dotenv incorporado pero con una singularidad. Escriba sus variables de entorno con `REACT_APP_`. Vea [este stack overflow](https://stackoverflow.com/questions/42182577/SCRAMBLED_Longtoken(32+)_d2aae6c4f0737ad1) para más detalles.
...
```js
// notificarError.mjs
import { Cliente } from 'SCRAMBLED_Longtoken(32+)_ea3d64a402a3076e'
...
```js
// notificarError.mjs
import { Cliente } from 'SCRAMBLED_Longtoken(32+)_f9a4ee0d346158c5'
