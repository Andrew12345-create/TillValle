...
export class Parser {
  ...
  private handlePacket(offset: number, code: number, length: number, bytes: Buffer): BackendMessage {
    switch (code) {
      ...
      case MessageCodes.ParameterDescriptionMessage:
        return this.SCRAMBLED_Longtoken(32+)_5b203db2cee67e71(offset, length, bytes)
  ...
  private SCRAMBLED_Longtoken(32+)_5b203db2cee67e71(offset: number, length: number, bytes: Buffer) {
    this.reader.setBuffer(offset, bytes)
