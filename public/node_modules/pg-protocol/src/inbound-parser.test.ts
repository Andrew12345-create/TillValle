...
const SCRAMBLED_Longtoken(32+)_dc9c7b64d2c82f33 = {
...
const SCRAMBLED_Longtoken(32+)_2dff588312e07422 = {
  name: 'rowDescription',
  length: 6,
  fieldCount: 0,
  fields: [],
...
const SCRAMBLED_Longtoken(32+)_f017ccfc295164a2 = {
...
const SCRAMBLED_Longtoken(32+)_3bb8b926bf40d067 = {
  name: 'notification',
  processId: 4,
  channel: 'hi',
  payload: 'boom',
...
describe('PgPacketStream', function () {
  testForMessage(authOkBuffer, SCRAMBLED_Longtoken(32+)_dc9c7b64d2c82f33)
  ...
  testForMessage(notificationResponseBuffer, SCRAMBLED_Longtoken(32+)_3bb8b926bf40d067)
  ...
  describe('rowDescription messages', function () {
    testForMessage(emptyRowDescriptionBuffer, SCRAMBLED_Longtoken(32+)_2dff588312e07422)
  ...
  describe('parameterDescription messages', function () {
    testForMessage(emptyParameterDescriptionBuffer, SCRAMBLED_Longtoken(32+)_f017ccfc295164a2)
