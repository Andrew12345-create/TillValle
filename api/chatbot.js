// Vercel serverless function: /api/chatbot
// Uses GEMINI_API_KEY from environment (set in Vercel) to call Gemini via @google/genai.
// Falls back to lightweight rule-based responses when the key is not present or the call fails.
